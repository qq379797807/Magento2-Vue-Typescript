...
const baseConfig = new WebpackConfig({
    ...
    entry: {
        vendor: ['vue', 'vue-class-component','vuex', 'apollo-client', 'apollo-link', 'apollo-link-http', 'apollo-cache-inmemory', 'graphql-tag', 'vue-lazyload', 'vue-cookies', 'vue-notification', 'vee-validate', 'axios']
    },
    output: {
